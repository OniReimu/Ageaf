...
test('Codex runtime does not duplicate output when item/completed repeats full text', async () => {
  const cliPath = path.join(process.cwd(), 'test', 'fixtures', 'codex-item-completed');
  const events: JobEvent[] = [];
