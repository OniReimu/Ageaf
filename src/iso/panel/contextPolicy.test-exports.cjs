/**
 * Test exports for contextPolicy
 *
 * Mirror the pure context policy logic for Node.js root tests.
 */
...
function shrinkBudgetForUsage(baseBudget, sessionUsageRatio) {
...
function detectContextIntent(input) {
...
function computeContextPolicy(input) {
  const hasSelection = Boolean(input.hasSelection);
