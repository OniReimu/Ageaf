class AgeafHost < Formula
  ...
  url "https://github.com/OniReimu/Ageaf/tree/main/releases/download/v0.1.0/ageaf-host-macos-node-bundle.tar.gz"
  # Placeholder checksum (must be replaced for real distribution)
